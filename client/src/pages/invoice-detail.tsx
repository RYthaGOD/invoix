  ...
  return (
    <div className="space-y-6">
              ...
              {invoice.nftMint && (
                <div className="flex items-center gap-2 px-3 py-2 bg-purple-500/10 border border-purple-500/30 rounded-lg">
                  ...
                  <div>
                    ...
                    <a
                      href={`https://orb.helius.dev/token/${invoice.nftMint}?cluster=${import.meta.env.VITE_SOLANA_NETWORK || 'devnet'}`}
                      target="_blank"
            ...
            <div className="space-y-3">
              {payments.map((payment) => (
                <div key={payment.id} className="flex justify-between items-center p-4 bg-white/5 rounded-lg">
                  ...
                  <a
                    href={`https://orb.helius.dev/tx/${payment.txSignature}?cluster=${import.meta.env.VITE_SOLANA_NETWORK || 'devnet'}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  ...
                  {payment.receiptNftMint && (
                    <a
                      href={`https://orb.helius.dev/token/${payment.receiptNftMint}?cluster=${import.meta.env.VITE_SOLANA_NETWORK || 'devnet'}`}
                      target="_blank"
                      rel="noopener noreferrer"
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  >
                    ...
                    <div className="text-left">
                      <div className="text-sm font-medium opacity-90">Pay on Desktop</div>
                ...
                <div className="flex justify-center">
                  ...
                  >
                    ...
                    Record an external/manual payment instead
                  </button>
                </div>
              </div>
            ) : (
      ...
      <Dialog open={showSendDialog} onOpenChange={setShowSendDialog}>
        <DialogContent className="glass-dialog border-white/10 text-white sm:max-w-md">
          <DialogHeader>
      ...
      <Dialog open={showSolanaPay} onOpenChange={setShowSolanaPay}>
        <DialogContent className="glass-dialog border-white/10 text-white sm:max-w-sm text-center">
          <DialogHeader>
      ...
      <Dialog open={showSellDialog} onOpenChange={setShowSellDialog}>
        <DialogContent className="glass-dialog border-purple-500/30 text-white">
          <DialogHeader>
